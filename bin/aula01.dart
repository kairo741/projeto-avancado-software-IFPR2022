...
void main(List<String> arguments) {
  ...
  // estrutura_decisao.compararNotas();
  // estrutura_decisao.imprimirNumeros();
  // estrutura_decisao.imprimirListas();

  //sadsad disco
  //sadsad disco sadsad
  //sadsadsadsadsadsad disco
  //sadsadsadsad adisco

  // functions.show();
  // paramless_functions_without_return.show();
  // paramless_functions_without_return.verifyApprovation();
  // paramless_functions_with_return.show();
  // paramless_functions_with_return.show();
  // print(paramless_functions_with_return.returnApprovationString());
